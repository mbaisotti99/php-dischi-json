...
<body>
    <header class="d-fex">
        <img class="logo" width="100" src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/19/Spotify_logo_without_text.svg/2048px-Spotify_logo_without_text.svg.png" alt="logo">
    </header>
    <div class="container">
